...
namespace Test2
{
	...
	public partial class MSBuildExtensionPackDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteSpecialOfferProduct(SpecialOfferProduct instance);
		...
		public MSBuildExtensionPackDataContext() : 
				base(global::Test2.Properties.Settings.Default.AdventureWorks2014ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public MSBuildExtensionPackDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public MSBuildExtensionPackDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public MSBuildExtensionPackDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public MSBuildExtensionPackDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnModifiedDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employee_PurchaseOrderHeader", Storage="_PurchaseOrderHeaders", ThisKey="BusinessEntityID", OtherKey="EmployeeID")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employee_SalesPerson", Storage="_SalesPerson", ThisKey="BusinessEntityID", OtherKey="BusinessEntityID", IsUnique=true, IsForeignKey=false)]
		public SalesPerson SalesPerson
		{
			get
			{
    ...
    partial void OnModifiedDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employee_PurchaseOrderHeader", Storage="_Employee", ThisKey="EmployeeID", OtherKey="BusinessEntityID", IsForeignKey=true)]
		public Employee Employee
		{
			get
			{
			...
			set
			{
							...
							|| (this._Employee.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._EmployeeID = value.BusinessEntityID;
					}
					else
					{
    ...
    partial void OnModifiedDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employee_SalesPerson", Storage="_Employee", ThisKey="BusinessEntityID", OtherKey="BusinessEntityID", IsForeignKey=true)]
		public Employee Employee
		{
			get
			{
