...
namespace MSBuildExtensionPack.EntityContracts
{
    ...
    /// </summary>
	public static partial class IBuildIdentifierHelper
	{
        ...
        /// </summary>
        /// <typeparam name="T">type inherit from <see cref="IBuildIdentifier"/></typeparam>
        /// <param name="input">The input.</param>
        /// <returns>a new instance</returns>
        public static T Create<T>(Framework.NameValueCollection input)
            where T : class, IBuildIdentifier, new()
        {
            try
            {
                T _retval = new T();
        ...
        public static void Copy<T1, T2>(T1 from, T2 to)
            where T1 : IBuildIdentifier
            where T2 : IBuildIdentifier
        {
