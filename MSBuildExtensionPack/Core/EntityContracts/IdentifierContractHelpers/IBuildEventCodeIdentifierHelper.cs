...
namespace MSBuildExtensionPack.EntityContracts
{
    ...
    /// </summary>
    public static partial class IBuildEventCodeIdentifierHelper
    {
        ...
        /// </summary>
        /// <typeparam name="T">type inherit from <see cref="IBuildEventCodeIdentifier"/></typeparam>
        /// <param name="input">The input.</param>
        /// <returns>a new instance</returns>
        public static T Create<T>(Framework.NameValueCollection input)
            where T : class, IBuildEventCodeIdentifier, new()
        {
            try
            {
                T _retval = new T();
            ...
            where T : class, IBuildEventCodeIdentifier, new()
        {
            try
            {
                ...
                T _retval = new T();
                int _Count = 0;
                _retval.Id = System.Int32.Parse(_SplitInputValue[_Count++]);
                return _retval;
            }
            catch
            {
        ...
        public static void Copy<T1, T2>(T1 from, T2 to)
            where T1 : IBuildEventCodeIdentifier
            where T2 : IBuildEventCodeIdentifier
        {
        ...
        public static T2 Clone<T1, T2>(T1 from)
            where T1 : IBuildEventCodeIdentifier
            where T2 : IBuildEventCodeIdentifier, new()
        {
            T2 _retval = new T2();
        ...
        /// </returns>
        public static string ToString(System.Int32 id)
        {
            string _Format = "Id:{0}";
