...
namespace MSBuildExtensionPack.EntityContracts
{
    ...
    /// </summary>
	public static partial class IOrganizationIdentifierHelper
	{
        ...
        /// </summary>
        /// <typeparam name="T">type inherit from <see cref="IOrganizationIdentifier"/></typeparam>
        /// <param name="input">The input.</param>
        /// <returns>a new instance</returns>
        public static T Create<T>(Framework.NameValueCollection input)
            where T : class, IOrganizationIdentifier, new()
        {
            try
            {
                T _retval = new T();
        ...
        public static void Copy<T1, T2>(T1 from, T2 to)
            where T1 : IOrganizationIdentifier
            where T2 : IOrganizationIdentifier
        {
        ...
        public static T2 Clone<T1, T2>(T1 from)
            where T1 : IOrganizationIdentifier
            where T2 : IOrganizationIdentifier, new()
        {
            T2 _retval = new T2();
