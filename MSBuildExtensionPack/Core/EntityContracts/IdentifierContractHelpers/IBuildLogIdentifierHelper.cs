...
namespace MSBuildExtensionPack.EntityContracts
{
    ...
    /// </summary>
	public static partial class IBuildLogIdentifierHelper
	{
        ...
        /// </summary>
        /// <typeparam name="T">type inherit from <see cref="IBuildLogIdentifier"/></typeparam>
        /// <param name="input">The input.</param>
        /// <returns>a new instance</returns>
        public static T Create<T>(Framework.NameValueCollection input)
            where T : class, IBuildLogIdentifier, new()
        {
            try
            {
                T _retval = new T();
        ...
        public static void Copy<T1, T2>(T1 from, T2 to)
            where T1 : IBuildLogIdentifier
            where T2 : IBuildLogIdentifier
        {
        ...
        public static T2 Clone<T1, T2>(T1 from)
            where T1 : IBuildLogIdentifier
            where T2 : IBuildLogIdentifier, new()
        {
            T2 _retval = new T2();
