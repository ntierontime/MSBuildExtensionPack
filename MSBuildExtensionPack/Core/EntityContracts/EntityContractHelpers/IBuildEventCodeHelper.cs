...
namespace MSBuildExtensionPack.EntityContracts
{
	...
	public static partial class IBuildEventCodeHelper
	{
        ...
        /// </summary>
        /// <typeparam name="T">type name inherit from <see cref="IBuildEventCode"/></typeparam>
        /// <returns>a new instance with default value</returns>
        public static T GetDefaultValue<T>()
            where T : IBuildEventCode, new()
        {
            T _retval = new T();
        ...
        public static Framework.NameValuePair BuildNameValuePair<T>(T input)
            where T : IBuildEventCode, IBuildEventCodeIdentifier, new()
        {
