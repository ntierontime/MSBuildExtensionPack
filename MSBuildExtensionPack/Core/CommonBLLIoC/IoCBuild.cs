...
namespace MSBuildExtensionPack.CommonBLLIoC
{
    ...
    public static class IoCBuild
    {
            ...
            MSBuildExtensionPack.DataSourceEntities.Build input)
        {
            ...
            _Request.Critieria = new MSBuildExtensionPack.DataSourceEntities.BuildCollection();
            ...
            )
        {
            ...
            _Request.Critieria = new MSBuildExtensionPack.CommonBLLEntities.BuildChainedQueryCriteriaCommon(
            ...
            )
        {
            ...
            _Request.Critieria = new MSBuildExtensionPack.CommonBLLEntities.BuildChainedQueryCriteriaAll(
);
            Framework.CommonBLLEntities.BusinessLogicLayerResponseMessageInteger _Response = _BusinessLogicLayerInstance.GetCountOfEntityOfAll(_Request);
            if (_Response.BusinessLogicLayerResponseStatus == Framework.CommonBLLEntities.BusinessLogicLayerResponseStatus.MessageOK)
            {
            ...
            )
        {
            ...
            _Request.Critieria = new MSBuildExtensionPack.CommonBLLEntities.BuildChainedQueryCriteriaByFKOnly(
            ...
            )
        {
            ...
            _Request.Critieria = new MSBuildExtensionPack.CommonBLLEntities.BuildChainedQueryCriteriaByIdentifier(
