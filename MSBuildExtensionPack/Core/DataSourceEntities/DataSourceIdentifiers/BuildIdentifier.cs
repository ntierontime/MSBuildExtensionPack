...
System.Int64 id)
        ...
        /// Initializes a new instance of the <see cref="BuildIdentifier"/> class.
        /// </summary>
        public BuildIdentifier(MSBuildExtensionPack.EntityContracts.IBuildIdentifier item)
        {
        ...
        {
            return MSBuildExtensionPack.EntityContracts.IBuildIdentifierHelper.ToString<BuildIdentifier>(this);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (_retval == true)
            {
                _retval = MSBuildExtensionPack.EntityContracts.IBuildIdentifierHelper.Equals<BuildIdentifier, BuildIdentifier>(this, (BuildIdentifier)obj);
            }
            return _retval;
        }
    ...
    /// </summary>
    public partial interface WithIdentifierContractBuild
    {
        /// <summary>
