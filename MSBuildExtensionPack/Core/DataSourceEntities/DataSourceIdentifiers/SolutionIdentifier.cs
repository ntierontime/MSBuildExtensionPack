...
System.Int32 id)
        ...
        /// Initializes a new instance of the <see cref="SolutionIdentifier"/> class.
        /// </summary>
        public SolutionIdentifier(MSBuildExtensionPack.EntityContracts.ISolutionIdentifier item)
        {
        ...
        {
            return MSBuildExtensionPack.EntityContracts.ISolutionIdentifierHelper.ToString<SolutionIdentifier>(this);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (_retval == true)
            {
                _retval = MSBuildExtensionPack.EntityContracts.ISolutionIdentifierHelper.Equals<SolutionIdentifier, SolutionIdentifier>(this, (SolutionIdentifier)obj);
            }
            return _retval;
        }
