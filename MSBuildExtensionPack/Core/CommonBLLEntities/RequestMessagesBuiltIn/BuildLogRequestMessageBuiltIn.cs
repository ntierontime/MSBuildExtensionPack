...
{
    /// <summary>
    /// BuiltIn BusinessLogicLayerRequestMessage for entity MSBuildExtensionPack.BuildLog
    /// </summary>
    public partial class BuildLogRequestMessageBuiltIn
        : Framework.CommonBLLEntities.BusinessLogicLayerRequestMessageBase<MSBuildExtensionPack.DataSourceEntities.BuildLogCollection>
    {
		#region constructors
    ...
    /// <summary>
    /// BuiltIn BusinessLogicLayerRequestMessage for entity MSBuildExtensionPack.DataSourceEntities.BuildLogIdentifier
    /// </summary>
    public partial class BuildLogRequestMessageBuiltInOfIdentifier
        : Framework.CommonBLLEntities.BusinessLogicLayerRequestMessageBase<MSBuildExtensionPack.DataSourceEntities.BuildLogIdentifier>
    {
        #region constructors
