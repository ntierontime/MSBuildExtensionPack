...
namespace MSBuildExtensionPack.WebApiClient
{
    ...
    public partial class BuildApiControllerClient : Framework.ViewModels.ApiControllerHttpClientBase
    {
        ...
        /// http://[host]/api/BuildApi/GetWPFullDetailsOfBuildVM?id=1
        /// </summary>
        /// <returns></returns>
        public async Task<MSBuildExtensionPack.ViewModelData.WPFullDetailsOfBuildVM> GetWPFullDetailsOfBuildVMAsync(
            System.Int64 id)
        {
            Dictionary<string, string> parameters = new Dictionary<string, string>();
            parameters.Add("id", id.ToString());
            string url = GetHttpRequestUrl(ActionName_GetWPFullDetailsOfBuildVM, parameters);
