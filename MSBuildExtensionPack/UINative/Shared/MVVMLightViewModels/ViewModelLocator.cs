...
namespace MSBuildExtensionPack.MVVMLightViewModels
{
    ...
    public class ViewModelLocator
    {
        ...
        #region MVVMViewModel #1.2: MSBuildExtensionPack.MVVMLightViewModels.WPsomethingOfBuildVM
        ...
        #region MVVMViewModel #1.3: MSBuildExtensionPack.MVVMLightViewModels.WPxTabSomethingOfBuildVM
        ...
        #region MVVMViewModel #1.4: MSBuildExtensionPack.MVVMLightViewModels.WPxTabFullDetailsOfBuildVM
        ...
        #region MVVMViewModel #1.5: MSBuildExtensionPack.MVVMLightViewModels.WPelseA1AsomethingOfBuildVM

        private static MSBuildExtensionPack.MVVMLightViewModels.WPelseA1AsomethingOfBuildVM m_MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM;
        public static MSBuildExtensionPack.MVVMLightViewModels.WPelseA1AsomethingOfBuildVM MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM_Static
        {
            get
            {
                if (m_MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM == null)
                {
                    CreateMSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM();
                }

                return m_MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM;
            }
        }

        public MSBuildExtensionPack.MVVMLightViewModels.WPelseA1AsomethingOfBuildVM MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM
        {
            get
            {
                return MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM_Static;
            }
        }

        /// <summary>
        /// Provides a deterministic way to delete the MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM property.
        /// </summary>
        public static void Clear_MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM()
        {
            if (m_MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM != null)
            {
                m_MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM.Cleanup();
                m_MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM = null;
            }
        }

        /// <summary>
        /// Provides a deterministic way to create the MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM property.
        /// </summary>
        public static void CreateMSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM()
        {
            if (m_MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM == null)
            {
                m_MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM = new MSBuildExtensionPack.MVVMLightViewModels.WPelseA1AsomethingOfBuildVM();
            }
        }

        #endregion MVVMViewModel: MSBuildExtensionPack.MVVMLightViewModels.WPelseA1AsomethingOfBuildVM
        ...
        #region MVVMViewModel #1.7: MSBuildExtensionPack.MVVMLightViewModels.WPCommonOfBuildLogVM
        ...
        #region MVVMViewModel #1.8: MSBuildExtensionPack.MVVMLightViewModels.WPCommonOfOrganizationVM
        ...
        #region MVVMViewModel #1.9: MSBuildExtensionPack.MVVMLightViewModels.WPCommonOfSolutionVM
        ...
        public static void Cleanup()
        {
            ...
            // #1.2: MSBuildExtensionPack.MVVMLightViewModels.WPsomethingOfBuildVM
            Clear_MSBuildExtensionPack_MVVMLightViewModels_WPsomethingOfBuildVM();

            // #1.3: MSBuildExtensionPack.MVVMLightViewModels.WPxTabSomethingOfBuildVM
            Clear_MSBuildExtensionPack_MVVMLightViewModels_WPxTabSomethingOfBuildVM();

            // #1.4: MSBuildExtensionPack.MVVMLightViewModels.WPxTabFullDetailsOfBuildVM
            Clear_MSBuildExtensionPack_MVVMLightViewModels_WPxTabFullDetailsOfBuildVM();

            // #1.5: MSBuildExtensionPack.MVVMLightViewModels.WPelseA1AsomethingOfBuildVM
            Clear_MSBuildExtensionPack_MVVMLightViewModels_WPelseA1AsomethingOfBuildVM();
            ...
            // #1.7: MSBuildExtensionPack.MVVMLightViewModels.WPCommonOfBuildLogVM
            Clear_MSBuildExtensionPack_MVVMLightViewModels_WPCommonOfBuildLogVM();

            // #1.8: MSBuildExtensionPack.MVVMLightViewModels.WPCommonOfOrganizationVM
            Clear_MSBuildExtensionPack_MVVMLightViewModels_WPCommonOfOrganizationVM();

            // #1.9: MSBuildExtensionPack.MVVMLightViewModels.WPCommonOfSolutionVM
