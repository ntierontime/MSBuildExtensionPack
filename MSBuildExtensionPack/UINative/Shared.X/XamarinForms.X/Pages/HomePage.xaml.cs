...
namespace MSBuildExtensionPack.XamarinForms.Pages {
    public partial class HomePage : ContentPage {
        ...
        private static void InitializeNavigationSettingCollectionInMainViewModel()
        {
            ...
            MSBuildExtensionPack.MVVMLightViewModels.ViewModelLocator.MainStatic.NavigationSettingCollection.Add(
                MSBuildExtensionPack.MVVMLightViewModels.WPxTabFullDetailsOfBuildVM.EntityName_Static
                , MSBuildExtensionPack.MVVMLightViewModels.WPxTabFullDetailsOfBuildVM.ViewName_Static
                , Framework.UIAction.ViewDetails, Framework.UIActionStatus.Launch, Framework.UIAction.Navigate, "/Pages/Build/WPxTabFullDetailsTabContainerOfBuild.xaml", typeof(MSBuildExtensionPack.XamarinForms.Pages.Build.WPxTabFullDetailsTabContainerOfBuild));
            ...
            MSBuildExtensionPack.MVVMLightViewModels.ViewModelLocator.MainStatic.NavigationSettingCollection.Add(
                MSBuildExtensionPack.MVVMLightViewModels.ItemVMBuild.EntityName_Static, MSBuildExtensionPack.MVVMLightViewModels.ItemVMBuild.ViewName_Details, Framework.UIAction.ViewDetails, Framework.UIActionStatus.Launch, Framework.UIAction.Navigate, "/Pages/Build/Details.xaml", typeof(MSBuildExtensionPack.XamarinForms.Pages.Build.Details));
