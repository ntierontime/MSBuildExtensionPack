            ...
            Messenger.Default.Register<Framework.UIActionStatusMessage>(
                ...
                message =>
                {
                    ...
                    dispatcherHelper.CheckBeginInvokeOnUI((Action)delegate ()
                    {
                        ...
                        {
                            var navigationSetting = MSBuildExtensionPack.MVVMLightViewModels.ViewModelLocator.MainStatic.NavigationSettingCollection.FirstOrDefault(t => t.SourceTypeFullName == message.SourceTypeFullName && t.UIAction == message.UIAction && t.UIActionStatus == message.UIActionStatus && t.SenderView == message.SenderView);
