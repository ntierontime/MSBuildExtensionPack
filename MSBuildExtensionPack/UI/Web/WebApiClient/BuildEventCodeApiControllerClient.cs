...
namespace MSBuildExtensionPack.WebApiClient
{
    ...
    public partial class BuildEventCodeApiControllerClient : Framework.ViewModels.ApiControllerHttpClientBase
    {
        ...
        /// <returns></returns>
        public async Task<MSBuildExtensionPack.ViewModelData.WPCommonOfBuildEventCodeVM> GetWPCommonOfBuildEventCodeVM(
        ...
        /// http://[host]/api/BuildEventCodeApi/GetWPEntityRelatedOfBuildEventCodeVM?id=1
        /// </summary>
        /// <returns></returns>
        public async Task<MSBuildExtensionPack.ViewModelData.WPEntityRelatedOfBuildEventCodeVM> GetWPEntityRelatedOfBuildEventCodeVMAsync(
            System.Int32 id)
        {
            Dictionary<string, string> parameters = new Dictionary<string, string>();
            parameters.Add("id", id.ToString());
            string url = GetHttpRequestUrl(ActionName_GetWPEntityRelatedOfBuildEventCodeVM, parameters);
