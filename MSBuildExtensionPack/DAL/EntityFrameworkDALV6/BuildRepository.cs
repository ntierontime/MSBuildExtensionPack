            ...
            )
        {
            var _ResultFromDataSource =
                (
                    ...
                    select new MSBuildExtensionPack.DataSourceEntities.Build.KeyInformation { Id = t.Id, Name = t.Name } into vD1
                    select vD1
                );
            var _retval = _ResultFromDataSource;
            ...
            )
        {
            var _ResultFromDataSource =
                (
                    ...
                    select new Framework.NameValuePair { Value = t.Id.ToString(), Name = t.Name } into vD2
                    select vD2
                );
            var _retval = _ResultFromDataSource;
            ...
            )
        {
            var _ResultFromDataSource =
                (
                    ...
                    join Organization_1 in this.LinqContext.Organizations on Solution_1.OrganizationId equals Organization_1.Id
                    join Organization_2 in this.LinqContext.Organizations on Organization_1.ParentId equals Organization_2.Id
                    select new Framework.RssItem { IdentifierInString = t.Id.ToString(), Title = t.Name, Description = t.Name, PubDate = t.BuildStartTime } into vD3
                    select vD3
                );
            var _retval = _ResultFromDataSource;
