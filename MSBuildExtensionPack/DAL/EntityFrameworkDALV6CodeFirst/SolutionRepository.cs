            ...
            )
        {
            var _ResultFromDataSource =
                (
                    ...
                    select new MSBuildExtensionPack.DataSourceEntities.Solution.Default { Organization_1_UniqueIdentifier = Organization_1.UniqueIdentifier, Organization_1_Name = Organization_1.Name, Id = t.Id, Organization_2Id = Organization_2.Id, Organization_2_UniqueIdentifier = Organization_2.UniqueIdentifier, Organization_2_Name = Organization_2.Name, ExternalParentId = t.ExternalParentId, Name = t.Name, Description = t.Description, OrganizationId = t.OrganizationId } into vD2
                    select vD2
                );
            ...
            )
        {
            var _ResultFromDataSource =
                (
                    ...
                    join Organization_1 in this.LinqContext.Organizations on t.OrganizationId equals Organization_1.Id
                    join Organization_2 in this.LinqContext.Organizations on Organization_1.ParentId equals Organization_2.Id
                    select new Framework.RssItem { IdentifierInString = t.Id.ToString().ToString(), Title = t.Name, Description = t.ExternalParentId } into vD1
                    select vD1
                );
            var _retval = _ResultFromDataSource;
            ...
            )
        {
            var _ResultFromDataSource =
                (
                    ...
                    select new MSBuildExtensionPack.DataSourceEntities.Solution.DefaultGroupedDataView { OrganizationId = tG.Key.OrganizationId, CountPerFK = _CountPerFK } into vD3
                    select vD3
                );
