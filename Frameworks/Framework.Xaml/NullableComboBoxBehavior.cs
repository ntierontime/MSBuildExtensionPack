...
{
    public class AllCaptionNullableComboBoxBehavior : NullableComboBoxBehavior
    {
        protected override string Caption
        {
            get
            {
                return Framework.Resx.UIStringResource.AllCaption;
            }
        }
    }

    public class SelectCaptionNullableComboBoxBehavior : NullableComboBoxBehavior
    {
        protected override string Caption
        {
            get
            {
                return Framework.Resx.UIStringResource.SelectCaption;
            }
        }
    }
    ...
    public abstract class NullableComboBoxBehavior : Behavior<ComboBox>
    {
        ...
        public bool IsNonNullValueSelected { get { return (bool)GetValue(IsNonNullValueSelectedProperty); } set { SetValue(IsNonNullValueSelectedProperty, value); SetValue(IsNullValueSelectedProperty, !value); } }
